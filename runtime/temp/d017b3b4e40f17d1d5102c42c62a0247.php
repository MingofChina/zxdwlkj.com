<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"/www/wwwroot/zxdwlkj.com/application/admin/view/places/index.html";i:1592630846;s:67:"/www/wwwroot/zxdwlkj.com/application/admin/view/layout/layout3.html";i:1593686780;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class="layui-this">查看活动地点</li>
        </ul>
        <div class="layui-tab-content">
            <form class="layui-form layui-form-pane" action="<?php echo url('admin/places/search'); ?>" method="get">
                    ...
                    <table class="layui-table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo url('places/delplaces',array('id'=>$vo['id'])); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                            </td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        </tbody>
