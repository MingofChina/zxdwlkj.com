<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/www/wwwroot/zxdwlkj.com/public/../application/admin/view/login/index.html";i:1592651578;}*/ ?>
...
<head>
    ...
    <link rel="stylesheet" href="/public/layout3/js/layui/css/layui.css">
    <link rel="stylesheet" href="/public/layout3/css/admin.css">
    <!--[if lt IE 9]>
    <script src="/public/layout3/js/html5shiv.min.js"></script>
    <script src="/public/layout3/js/respond.min.js"></script>
    <style>
...
<form class="layui-form login-form" action="<?php echo url('Login/zuologin'); ?>" method="post">
