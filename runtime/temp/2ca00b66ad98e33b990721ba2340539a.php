<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"/www/wwwroot/zxdwlkj.com/application/admin/view/slideimg/add.html";i:1591931504;s:67:"/www/wwwroot/zxdwlkj.com/application/admin/view/layout/layout3.html";i:1593686780;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form id="good" class="layui-form form-container" action="<?php echo url('slideimg/zuoadd'); ?>" method="post">
