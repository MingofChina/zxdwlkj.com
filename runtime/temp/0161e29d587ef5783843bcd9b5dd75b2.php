<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"/www/wwwroot/zxdwlkj.com/application/admin/view/orderdetail/index.html";i:1592642808;s:67:"/www/wwwroot/zxdwlkj.com/application/admin/view/layout/layout3.html";i:1593686780;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class="layui-this">查看预约</li>
        </ul>
        <div class="layui-tab-content">
            <form class="layui-form layui-form-pane" action="<?php echo url('admin/orderdetail/search'); ?>" method="get">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <select name="name">
                            ...
                            <?php if(is_array($placess) || $placess instanceof \think\Collection || $placess instanceof \think\Paginator): if( count($placess)==0 ) : echo "" ;else: foreach($placess as $key=>$vo): ?>
                    ...
                    <table class="layui-table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo url('orderdetail/status',array('id'=>$vo['id'])); ?>" class="layui-btn layui-btn-normal layui-btn-mini">未联系</a>
                                <?php else: ?>
                                <a class="layui-btn layui-btn-normal layui-btn-mini">已联系</a>
                                <?php endif; ?>
                            	

                                <a href="<?php echo url('orderdetail/del',array('id'=>$vo['id'])); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                            </td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        </tbody>
