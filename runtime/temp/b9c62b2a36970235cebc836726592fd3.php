<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/www/wwwroot/zxdwlkj.com/application/admin/view/active/updateactive.html";i:1593504746;s:67:"/www/wwwroot/zxdwlkj.com/application/admin/view/layout/layout3.html";i:1593686780;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form id="good" class="layui-form form-container" action="<?php echo url('active/zuoupdateactive'); ?>" method="post">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="place_cate" lay-verify="required">
                                ...
                                <option value="<?php echo $vo['name']; ?>" <?php if(($vo['name'] == $data['name'])): ?> selected <?php endif; ?>><?php echo $vo['name']; ?></option>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="title" value="<?php echo $data['title']; ?>" required  lay-verify="required" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="hidden" id="pic" name="banner" value="<?php echo $data['banner']; ?>">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block" >
                            <img src="<?php echo $data['banner']; ?>" id="slideimg">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <input type="text" id="date2" name="start_time" value="<?php echo $data['start_time']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" id="date3" name="end_time" value="<?php echo $data['end_time']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="place" value="<?php echo $data['place']; ?>" required  lay-verify="required"  class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="descrip" value="<?php echo $data['descrip']; ?>" required  lay-verify="required" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="hidden" id="detail_pics" name="detail_pics" value="<?php echo $data['detail_pics']; ?>">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="start_day" value="<?php echo $data['start_day']; ?>" required  lay-verify="required" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="lesson_time" value="<?php echo $data['lesson_time']; ?>" required  lay-verify="required" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="lesson_function" value="<?php echo $data['lesson_function']; ?>" required  lay-verify="required" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="lesson_coach" value="<?php echo $data['lesson_coach']; ?>" required  lay-verify="required"  class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="lesson_learned" value="<?php echo $data['lesson_learned']; ?>" required  lay-verify="required"  class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="lesson_together" value="<?php echo $data['lesson_together']; ?>" required  lay-verify="required"  class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="personal_inspiration" value="<?php echo $data['personal_inspiration']; ?>" required  lay-verify="required"  class="layui-input">
                        </div>
                    </div>
